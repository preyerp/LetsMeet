...
import com.where.letsmeet.model.ChatModel.Comment
...
class MessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageViewBack = findViewById<ImageView>(R.id.messageActivity_ImageView_back)
        ...
        checkChatRoom()
        val buttonToFind = findViewById<ImageView>(R.id.messageActivity_Place_Button)
    ...
    inner class RecyclerViewAdapter : RecyclerView.Adapter<RecyclerViewAdapter.MessageViewHolder>() {
        ...
        private var friend2 : Friend? = null
        ...
        override fun onBindViewHolder(holder: MessageViewHolder, position: Int) {
            ...
            if(comments[position].uid.equals(uid)){ // 본인 채팅
                ...
                System.out.println("sex2" + friend.toString());
                if(comments[position].uid == "IgjF05gZ11PDQGjEhxuDECbnsMD2"){

                    holder.textView_name.text = "Harry"
                }
                if(comments[position].uid == "QeBeS2uRDlYUPH9610lFsWaueN12"){
                    holder.textView_name.text = "Jake"

                }
                if(comments[position].uid == "39vzcOPyXEPfHTAD5hiHAb0JMAO2"){
                    holder.textView_name.text = "Johnny"

                }
                if(comments[position].uid == "E9vzcOPyXEPfHTAD5hiHAb0JMAO2"){
                    holder.textView_name.text = "Kane"

                }
                if(comments[position].uid == "VH96c6X6oGX5S8b3HcsfxYtUENZ2"){
                    holder.textView_name.text = "Fabio"
